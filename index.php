                ...
                <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse p-0">
                    ...
                    <div class="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_2">Nous concernent</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_3"> Nos Services</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_4">Liste des prix</a>
                            </li>
                ...
                <div class="col-md-8 ms-sm-auto col-lg-9 p-0">
                    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        ...
                                        <a class="btn custom-btn smoothscroll mb-2" href="#section_3">ce que nous faisons</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="custom-block d-lg-flex flex-column justify-content-center align-items-center">
                                ...
                                <h4><strong class="text-white">dépeche-toi ! avoir une bonne coupe de cheveux.</strong></h4>

                                <a href="#booking-section" class="smoothscroll btn custom-btn custom-btn-italic mt-3">réserver un siège</a>
                            </div>
                    </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-12 mx-auto">
                                    ...
                                    <?php 
                                        ...
                                        include_once"admins/con_bdd.php";
                                     ...
                                     ?>
                                        ...
                                        <div class="col-lg-5  col- custom-block-bg-overlay-wrap me-lg-5 mb-5 mb-lg-5">
                                            
                                            <img  src="admins/images_bdd/<?=$row['img']?>" class="custom-block-bg-overlay-image img-fluid" alt="">
                            ...
                            <div class="col-lg-10 col-12 mx-auto">
                                <form action="#" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                    ...
                                    <div class="text-center mb-5">
                                        <h2 class="mb-1">réserver un siège</h2>

                                        <p>veuillez remplir le formulaire et nous vous répondrons</p>
                                    </div>
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="text" name="nom" id="bb-name" class="form-control" placeholder="Full name" required>
                                            </div>

                                            <div class="col-lg-6 col-12">
                                                <input type="tel" class="form-control" name="tel" placeholder="Mobile 05-86-00-42-33"  required="">
                                            </div>
                                        
                                            <div class="col-lg-6 col-12">
                                                <input class="form-control" type="time" name="heure" value="08:30" required/>
                                            </div>

                                            <div class="col-lg-6 col-12">
                                                <select class="form-select form-control" name="type" id="bb-branch" aria-label="Default select example" required>
                                                    <option selected="">Select Branches</option>
                                                   <?php require_once('admins/contenubranche.php'); ?>
                                                </select>

                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <input type="date" name="dated" id="date" class="form-control" placeholder="Date" required>
                                            </div>

                                            <div class="col-lg-6 col-12">
                                                <input type="number" name="nbpersonne" id="bb-number" class="form-control" placeholder="Number of People" required>
                                            </div>
                                        </div>

                                        <textarea name="message" rows="3" class="form-control" id="message" placeholder="Comment (Optionals)" required></textarea>

                                        <div class="col-lg-4 col-md-10 col-8 mx-auto">
                                            <button type="submit" class="form-control" name="btn2">Envoyer</button>
                                        </div>
                                    </div>
                                </form>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-12">
                                    <div class="price-list-thumb-wrap">
                                        <div class="mb-4">
                                            <h2 class="mb-2">Liste des prix</h2>
                        ...
                        <div class="container">
                            <div class="row">   
                                ...
                                <div class="col-lg-8 col-12 mx-auto">
                                    <h2 class="text-center">Dis bonjour</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-5 col-12 contact-block-wrap mt-5 mt-lg-0 pt-4 pt-lg-0 mx-auto">
                                    <div class="contact-block">
                                        <h6 class="mb-0">
                                            ...
                                            <strong>Ouvert tous les jours</strong>
                ...
                <footer class="site-footer">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12">
                                <h4 class="site-footer-title mb-4">Nos succursales</h4>
                            </div>
